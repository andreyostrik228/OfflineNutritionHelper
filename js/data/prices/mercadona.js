...
PRICE_CATALOGS.mercadona = {
  ...
  pricesPer100g: {
    ...
    "bacalao":                       1.9773,  // real: Filetes de bacalao MareDeus ultracongelado (media de 3 cortes: 19,773 EUR/kg; se vende a granel, sin envase) (Granada wh 3968)
    ...
    "lomo de cerdo":                 0.686,  // real: Chuletas lomo de cerdo finas (media de 5 cortes: 6,86 EUR/kg; bandeja media 638 g) (Granada wh 3968)
    ...
    "merluza":                       1.15,  // real: Merluza a rodajas (media de 6 cortes: 11,5 EUR/kg; bandeja media 994 g) (Granada wh 3968)
    ...
    "muslo de pollo deshuesado":     0.7263,  // real: Muslos deshuesados con piel de pollo certificado alimentado con un 50% de maíz (media de 4 cortes: 7,263 EUR/kg; bandeja media 568 g) (Granada wh 3968)
    ...
    "pechuga de pavo":               0.875,  // real: Filetes pechuga de pavo (8,75 EUR/kg, bandeja 590 g) (Granada wh 3968)
    "pechuga de pollo":              0.7975,  // real: Filetes pechuga de pollo corte fino (media de 4 cortes: 7,975 EUR/kg; bandeja media 558 g) (Granada wh 3968)
    ...
    "salmon":                        4.5,  // real: Filete de salmón rosado salvaje con piel Hacendado ultracongelado (45 EUR/kg; se vende a granel, sin envase) (Granada wh 3968)
    ...
    "ternera magra":                 1.7467,  // real: Filetes de vacuno 1º B añojo para plancha o guisar (media de 3 cortes: 17,467 EUR/kg; bandeja media 533 g) (Granada wh 3968)
    ...
    "conejo":                        0.9,  // real: Medio conejo troceado (media de 2 cortes: 9 EUR/kg; bandeja media 980 g) (Granada wh 3968)
    "jamon serrano":                 2.5,  // real: Jamón serrano cortado a máquina (Granada wh 3968)
    "solomillo de ternera":          4.07,  // real: Solomillo de vacuno añojo para plancha (40,7 EUR/kg, bandeja 300 g) (Granada wh 3968)
    "lubina":                        0.995,  // real: Lubina limpia con cabeza (media de 5 cortes: 9,95 EUR/kg; bandeja media 440 g) (Granada wh 3968)
    "rape":                          1.85,  // real: Cola de rape del Cabo sin piel Hacendado ultracongelada (18,5 EUR/kg; se vende a granel, sin envase) (Granada wh 3968)
